...
console.log(artGallery.addArtwork('Great One','30 x 40', 'Van Gogh')) // check input
//console.log(artGallery.addArtwork('Great One','30 x 40', 'Van gogh')) // case sensitive as well >> checking how it handles errors
console.log(artGallery.calculateCosts(1500, 1000, true)) // check input
console.log(artGallery.organizeExhibits(1, 7)) // took me some time to understand the output
